...
**Arithmetic Pupil’s Book Standard Two** — This is an English-language arithmetic textbook for Standard Two pupils, produced in Tanzania by the Tanzania Institute of Education, so it is aimed at early primary learners, roughly ages 7–8. It covers foundational maths topics including number recognition to 999, sequencing, place value, addition, subtraction, multiplication, division, simple fractions, measurement, and 2D and 3D shapes. The book uses a very practical, activity-based approach with songs, games, pictures, word problems and everyday local examples, emphasising mastery of basic skills, step-by-step methods, and application in real-life situations.
...
```
ARITHMETIC-PUPIL-S-STD-2-NOVEMBER-6-2024/
├── adt/                              # THE WEB APP
...
├── ARITHMETIC-PUPIL-S-STD-2-NOVEMBER-6-2024.db                    # SQLite database (pipeline state)
├── ARITHMETIC-PUPIL-S-STD-2-NOVEMBER-6-2024.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for Arithmetic Pupil’s Book Standard Two, certificate number 1646, listing Tanzania Institute of Education as publisher and author, ISBN 978-9912-753-59-4, approved on 11th September 2024 for use in Standard Two primary schools, with the Commissioner for Education’s signature.",
  "gl001": "abacus",
  "gl001_def": "a tool with beads used to help count and show numbers",
  "qz001_que": "What number comes after 109?",
  "qz001_o0": "1) 110",
  "qz001_o0_exp": "✅ Correct! When counting forwards, 110 comes after 109."
}
```
...
```json
{
  "abacus": {
    "word": "abacus",
    "definition": "a tool with beads used to help count and show numbers",
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What number comes after 109?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="✅ Correct! When counting forwards, 110 comes after 109." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) 110</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ARITHMETIC-PUPIL-S-STD-2-NOVEMBER-6-2024.pdf` |
| Pipeline database | `ARITHMETIC-PUPIL-S-STD-2-NOVEMBER-6-2024.db` (SQLite) |
